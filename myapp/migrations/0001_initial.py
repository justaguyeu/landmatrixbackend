# Generated by Django 5.1 on 2024-11-15 21:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('stock_item', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='myapp.stockitem2')),
            ],
        ),
        migrations.AddField(
            model_name='stockitem2',
            name='stock_main',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='branches', to='myapp.stockitem2main'),
        ),
        migrations.CreateModel(
            name='StockRestock',
            fields=[
